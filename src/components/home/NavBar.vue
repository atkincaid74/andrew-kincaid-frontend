<template>
  <v-navigation-drawer app clipped v-model="navBarVisible">
    <v-list dense nav class="py-0">
      ...
      <v-list-item v-if="username === null" @click="goToLogin">
        <v-list-item-icon>
          <UserIcon></UserIcon>
        </v-list-item-icon>
      ...
      <v-list-item @click="goHome" class="my-1">
        <v-list-item-icon>
      ...
      <v-list-item @click="goGolf" class="my-1">
        <v-list-item-icon>
          <v-icon>{{ GolfIcon }}</v-icon>
        </v-list-item-icon>
        <v-list-item-title>Golf</v-list-item-title>
      </v-list-item>
      ...
      >
        ...
        <v-list-item-title>Golf Admin Tools</v-list-item-title>
      </v-list-item>
      ...
      >
        ...
        <v-list-item-title>The Real Super-Contest</v-list-item-title>
      </v-list-item>
      ...
      >
        ...
        <v-list-item-title>Pick 6</v-list-item-title>
      </v-list-item>
    </v-list>
...
export default {
  ...
  computed: {
    ...
    navBarVisible: {
      ...
      set(value) {
        this.$store.commit("toggleNavBar", value);
      },
    },
  },
  methods: {
